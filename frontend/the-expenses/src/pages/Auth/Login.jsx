          ...
          <div className="relative flex flex-col justify-start h-full overflow-hidden">
            ...
            >
              ...
              >
                ...
                >
                  <div className={`flex items-center border-2 ${emailFocused ? 'border-green-500 shadow-lg shadow-green-100' : 'border-gray-300'} 
                    ...
                    <div className={`pl-4 py-3 transition-colors duration-300 
                      ${emailFocused ? 'text-green-600' : 'text-gray-400'}`}>
                ...
                >
                  <div className={`flex items-center border-2 ${passwordFocused ? 'border-green-500 shadow-lg shadow-green-100' : 'border-gray-300'} 
                    ${isPasswordValid && password.length > 0 ? 'bg-green-50' : ''} rounded-lg overflow-hidden 
                    transition-all duration-300 transform ${passwordFocused ? 'scale-[1.01]' : 'scale-100'}`}>
                    <div className={`pl-4 py-3 transition-colors duration-300 
                      ${passwordFocused ? 'text-green-600' : 'text-gray-400'}`}>
                ...
                <motion.button
                  type="submit"
                  disabled={isLoading}
                  className={`w-full py-3.5 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium 
                    tracking-wide text-sm transition-all duration-300 transform hover:scale-[1.01] 
                    active:scale-95 shadow-md hover:shadow-xl hover:shadow-green-200 relative overflow-hidden
                ...
                >
                  {isLoading ? (
                    ...
                    <div className="flex items-center justify-center">
                      ...
                      <FiArrowRight className="h-4 w-4 animate-pulse-horizontal" />
                    </div>
                  )}
